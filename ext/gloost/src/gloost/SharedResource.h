...
#ifndef H_GLOOST_SHARED_RESOURCE
#define H_GLOOST_SHARED_RESOURCE
...
class SharedResource
{
    ...
    // class destructor
	  ...
	  virtual SharedResource* takeReference();
  ...
  protected:
    ...
    static unsigned int _uniqueResourceIdCounter;
	  ...
	  // protects the shared id counter
	  static std::mutex  _idMutex;
...
#endif // H_GLOOST_SHARED_RESOURCE
