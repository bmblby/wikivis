...
*/
void
Dcs::setRotate(const mathType x, const mathType y, const mathType z)
{
...
*/
void
Dcs::setRotate(const Vector3& v, mathType angle)
{
...
*/
void
Dcs::setTranslate(const mathType x, const mathType y, const mathType z)
{
...
*/
void
Dcs::setScale(const mathType x, const mathType y, const mathType z)
{
...
//    _resultMatrix = _rotMatrix*(_transMatrix*_scaleMatrix);
    setClean();
  }
}
